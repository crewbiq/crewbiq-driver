/**
 * CrewBIQ Core loader v0.2.7
 *
 * Loads the stable authenticated Core runtime, full restore, Settings durability,
 * durable owner snapshots, authenticated OCR transport, safe multi-driver invoice
 * review, and vendor item alias normalization before the inline app executes.
 */
(function () {
  'use strict';
