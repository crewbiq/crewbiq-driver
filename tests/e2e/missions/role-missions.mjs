export const ROLE_MISSIONS = Object.freeze({
  ...
  driver: Object.freeze({
    ...
    tenantAliases: ['A'],
    specs: ['tests/e2e/staging-auth-restore.spec.mjs', 'tests/e2e/staging-load-lifecycle.spec.mjs', 'tests/e2e/staging-pti-lifecycle.spec.mjs', 'tests/e2e/staging-expenses-lifecycle.spec.mjs', 'tests/e2e/staging-dispute-lifecycle.spec.mjs'],
    journeys: ['AUTH-01', 'AUTH-02', 'RESTORE-01', 'LEGACY-01', 'LOAD-01', 'PTI-01', 'EXPENSES-01', 'DISPUTE-01'],
  }),
